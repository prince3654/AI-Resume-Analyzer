...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="#" style="text-decoration: none; color:rgb(0, 255, 115);">Prince Raj</a></b>' 
    ...
    if choice == 'User':
        tab1, tab2 = st.tabs(["AI Resume Analyzer & Category Prediction", "Job Description Matching"])

    # Tab 1: AI Resume Analyzer and Category Prediction
        with tab1:
            st.header("AI Resume Analyzer & Category Prediction")
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Prince ! Total %d " % values + " User's Have Used Our Tool : )")                
